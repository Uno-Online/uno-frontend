...
export function FormUser({setLoginOrGuest}:FormProps){
    ...
    async function login({email,password,checkbox}:LoginProps){
        ...
        try{
            ...
            const response = await api.post('/login', {email,password,rememberLogin:checkbox})
        ...
        <form className={styles.form} onSubmit={handleSubmit(login)}>
            ...
            <div className={styles['content-form']}>
                <header className={styles['header-form']}>
                    <button type="button" className={styles['button-header-primary']}>Entrar</button>
                ...
                <div className={styles['input-group']}>
                        ...
                        <label className={styles.label}  htmlFor="email">
                            <span>Email</span>
                        <input type="email" className={errors.password?.message?`${styles['input-error']}`:''} placeholder='Digite seu email' {...register('email')}/>
                        ...
                        <label  className={styles.label} htmlFor="password">
                            <span>Password</span>
                        <input type="password" className={errors.password?.message?`${styles['input-error']}`:''} 
               ...
               <button aria-label='Entrar' disabled={isSubmitting} type='submit' className={styles['button-form']}> Entrar </button>
